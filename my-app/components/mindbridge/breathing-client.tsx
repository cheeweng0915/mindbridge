    ...
    <div className="bg-white py-10 sm:py-14">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 sm:gap-8 sm:px-6">
        <section className="grid gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
          ...
          <div className="mindbridge-card p-5 sm:p-6">
            <p className="mindbridge-label text-black/45">Rhythm</p>
            <p className="mt-4 text-2xl font-medium leading-[1.1] text-[#010120] sm:text-3xl sm:leading-[1.08]">
              Inhale 4, hold 7, exhale 8.
            </p>
          </div>
        </section>

        <section className="mindbridge-dark-card overflow-hidden p-4 text-white sm:p-6 md:p-8">
            ...
            <div className="flex min-h-[320px] flex-col items-center justify-center rounded-[8px] border border-white/[0.12] bg-white/[0.04] p-5 sm:min-h-[420px] sm:p-6">
              ...
              >
                <div className="rounded-full bg-[#010120]/85 px-6 py-4">
                  <p className="mindbridge-label text-white/60">
                    {phase.name}
                  </p>
              ...
              <p className="mt-8 text-xl font-medium text-white">{phase.cue}</p>
